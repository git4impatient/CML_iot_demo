...
# too long to run
pplotdf1 =myspark.sql('select label, sensor1, sensor2, sensor3, sensor4 from iotdata limit 1000')
pplotdf1.show(3)
...
iotdf = myspark.sql('select label, sensor1, sensor2, sensor3, sensor4 from iotdata ') #limit 500000')
